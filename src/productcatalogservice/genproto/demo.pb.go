...
type Product struct {
	...
	PetTypes      []string               `protobuf:"bytes,7,rep,name=pet_types,json=petTypes,proto3" json:"pet_types,omitempty"`
	PetAges       []string               `protobuf:"bytes,8,rep,name=pet_ages,json=petAges,proto3" json:"pet_ages,omitempty"`
	PetSizes      []string               `protobuf:"bytes,9,rep,name=pet_sizes,json=petSizes,proto3" json:"pet_sizes,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Product) GetPetTypes() []string {
	if x != nil {
		return x.PetTypes
	}
	return nil
...
func (x *Product) GetPetAges() []string {
	if x != nil {
		return x.PetAges
	}
	return nil
...
func (x *Product) GetPetSizes() []string {
	if x != nil {
		return x.PetSizes
	}
	return nil
...
const file_demo_proto_rawDesc = "" +
	...
	"categories\x12\x1b\n" +
	"\tpet_types\x18\a \x03(\tR\bpetTypes\x12\x19\n" +
	"\bpet_ages\x18\b \x03(\tR\apetAges\x12\x1b\n" +
	"\tpet_sizes\x18\t \x03(\tR\bpetSizes\"H\n" +
